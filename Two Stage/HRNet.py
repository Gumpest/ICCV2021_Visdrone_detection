...
train_pipeline = [
    ...
    dict(
        type='Normalize',
        mean=[95.79, 97.242, 93.648],
        std=[59.189, 59.07, 61.002],
        to_rgb=True),
...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '/home/zy123/VisDrone2019-DET-train-test-split/VisDrone2019-DET_train-test_coco.json',
    ...
    val=dict(
        type='CocoDataset',
        ann_file=
        '/home/zy123/mmdetection/mmdet/data/VisDrone2019-DET_val_coco.json',
