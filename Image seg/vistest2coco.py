...
def convert_to_cocodetection(dir, output_dir):
    train_dir = os.path.join(dir, "VisDrone2019-DET-test-challengesplit")
    ...
    for mode in ["train"]:
        ...
        with open(f'{output_dir}/VisDrone2019-DET_testsplit_coco.json', 'w') as json_file:
