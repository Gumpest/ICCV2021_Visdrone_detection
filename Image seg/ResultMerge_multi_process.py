...
def mergebypoly(srcpath, dstpath):
    ...
    mergebase_parallel(srcpath,
              dstpath,
              py_cpu_nms) # py_cpu_nms_poly_fast
if __name__ == '__main__':
    mergebypoly(r"/home/zy/YOLOv5/yolov5/runs/detect/exp30_traintest_split/", r"/home/lxc/visdrone/test_merge/dota_merge/yolov5_nms/")
    # mergebyrec()